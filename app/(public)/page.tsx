  ...
  return (
    <div className="py-2 sm:py-8">
      <section className="grid border-y border-border lg:grid-cols-[minmax(0,1fr)_22rem]">
        <div className="px-5 py-4 sm:px-8 sm:py-8">
        ...
        <div className="relative aspect-[16/6] overflow-hidden border-t border-border lg:aspect-auto lg:min-h-full lg:border-t-0 lg:border-l">
          <HomeHeroImage />
        </div>
      </section>
