...
นำออกแล้ว การเพิ่มข้อมูลเดิมต้องเสนอให้คืนสถานะแทนการสร้างประวัติซ้ำ ผู้เล่นคนเดียวกัน
สามารถมีข้อมูลแยกกันในคนละทีมได้
...
จำนวนแถวต่อ batch มีขีดจำกัดที่เหมาะกับการกรอกในหน้าเว็บเพื่อป้องกัน payload
ผิดปกติ แต่ไม่เพิ่ม workflow CSV ในระยะนี้
