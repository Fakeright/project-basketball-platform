...
ตรวจสถานะรายทีมแบบอ่านอย่างเดียวได้ด้วย `npx tsx scripts/audit-legacy-team-members.ts` รายงานแสดงเฉพาะ team ID, รูปแบบทีม, จำนวนสมาชิกเดิม, จำนวน `TeamPlayer`, จำนวนและสถานะประวัติการสมัคร และ readiness/issues โดยไม่แสดงข้อมูลส่วนบุคคล การตรวจฐาน development เมื่อ 9 สิงหาคม 2026 พบ 5 ทีมที่ยังมี active legacy rows และยังไม่พร้อมลบข้อมูลเดิม
