...
- ทีมที่ไม่มีประวัติการสมัครลบถาวรได้ ส่วนทีมที่มีประวัติถูกปิดใช้งานเพื่อคงข้อมูลเดิม โดยการดำเนินการต้องยืนยันชื่อทีมและผ่านการตรวจสิทธิ์บน server
- ระยะนี้ไม่รองรับการนำเข้ารายชื่อด้วย CSV

โมเดล `TeamMember` เดิมยังคงอยู่เพื่อรักษาข้อมูลระหว่างเปลี่ยนผ่าน และไม่ใช่แหล่งข้อมูลรายชื่อที่ใช้งานอยู่ ตรวจจำนวนข้อมูลเดิมแบบอ่านอย่างเดียวได้ด้วย `npx tsx scripts/audit-legacy-team-members.ts` การลบโมเดลและตารางนี้ต้องเป็น migration แยกที่ได้รับอนุมัติหลังตรวจรายงาน audit แล้วเท่านั้น
