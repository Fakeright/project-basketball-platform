...
- ทีมจะลบถาวรได้เมื่อไม่มีทั้งประวัติการสมัครและ `TeamMember` เดิมแม้แต่แถวเดียว หากมีประวัติอย่างใดอย่างหนึ่งระบบจะปิดใช้งานทีมเพื่อรักษาข้อมูล โดยการดำเนินการต้องยืนยันชื่อทีมและผ่านการตรวจสิทธิ์บน server
