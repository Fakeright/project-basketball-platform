...
export async function publishExternalBracket(
  input: Input,
  actor: Actor,
  ...
  if (context.publishedRevision && !access.reason) throw new Error("REASON_REQUIRED")

  return dependencies.externalBrackets.publishRevision({
